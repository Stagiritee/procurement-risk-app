...
const STAGES: Record<StageKey, StageConfig> = {
  plan: {
    ...
    probabilityCriteria: [
      ...
      { key: "stagesDuration", label: "Этапность и длительность", scale: ["1 - этапы не предусмотрены, срок исполнения до 6 месяцев", "2 - этапы не предусмотрены, срок исполнения более 6 месяцев", "3 - предусмотрено 2 этапа в пределах 1 года", "4 - предусмотрено 2 этапа в пределах 2 лет", "5 - предусмотрено 2 этапа в пределах 3 лет"] },
  ...
  proc: {
    ...
    probabilityCriteria: [
      ...
      { key: "commissionExperience", label: "Опыт работы комиссии", scale: ["1 - все обучены, есть опыт", "2 - 2 и больше человек обучены, опыт есть", "3 - 1 человек обучен, опыт средний", "4 - обучение отсутствует, опыт низкий", "5 - состав комиссии новый, опыта нет"] },
  ...
  exec: {
    ...
    probabilityCriteria: [
      ...
      { key: "acceptanceCommissionExperience", label: "Опыт работы комиссии", scale: ["1 - все обучены, есть опыт", "2 - 2 и больше человек обучены, опыт есть", "3 - 1 человек обучен, опыт средний", "4 - обучение отсутствует, опыт низкий", "5 - состав комиссии новый, опыта нет"] },
      ...
      { key: "paymentComplexity", label: "Потенциальная комплексность приёмки", scale: ["1 - единоразовая оплата", "2 - оплата в 2 этапа", "3 - оплата в 3 и более этапа с наличием аванса", "4 - оплата в несколько этапов с наличием аванса", "5 - комплексная оплата с казначейским сопровождением"] },
    ],
    indicators: [
